...
{
    [DisplayName("SPackage Permissions")]
    ...
    public static class SPackages
    {
        ...
        [Description("Allows modifying existing SPackage details.")]
        public const string Edit = "Permissions.SPackages.Edit";
        ...
        [Description("Allows importing SPackage records.")]
        public const string Import = "Permissions.SPackages.Import";
    }
}
