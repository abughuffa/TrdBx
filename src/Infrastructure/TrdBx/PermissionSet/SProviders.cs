...
{
    [DisplayName("SProvider Permissions")]
    ...
    public static class SProviders
    {
        ...
        [Description("Allows modifying existing SProvider details.")]
        public const string Edit = "Permissions.SProviders.Edit";
        ...
        [Description("Allows importing SProvider records.")]
        public const string Import = "Permissions.SProviders.Import";
    }
}
public class SProvidersAccessRights
{
