...
{
    [DisplayName("WialonTask Permissions")]
    [Description("Set permissions for WialonTask operations.")]
    public static class WialonTasks
    {

        [Description("Allows viewing WialonTask details.")]
        public const string View = "Permissions.WialonTasks.View";
...
public class WialonTasksAccessRights
{
