...
{
    [DisplayName("TrackingUnitModel Permissions")]
    ...
    public static class TrackingUnitModels
    {
        ...
        [Description("Allows modifying existing TrackingUnitModel details.")]
        public const string Edit = "Permissions.TrackingUnitModels.Edit";
        ...
        [Description("Allows importing TrackingUnitModel records.")]
        public const string Import = "Permissions.TrackingUnitModels.Import";
    }
}
