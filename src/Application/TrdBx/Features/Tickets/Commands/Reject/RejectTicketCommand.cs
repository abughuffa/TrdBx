...
public class RejectTicketCommand : ICacheInvalidatorRequest<Result<int>>
{
    ...
    [Display(Name = "Note")] public string Note { get; set; } = string.Empty;
...
public class RejectTicketCommandHandler : IRequestHandler<RejectTicketCommand, Result<int>>
{
  ...
  private readonly IApplicationDbContextFactory _dbContextFactory;
    ...
    public async ValueTask<Result<int>> Handle(RejectTicketCommand request, CancellationToken cancellationToken)
    {
