...
#nullable disable warnings
    public async Task<Result<bool>> Handle(ImportDataCommand request, CancellationToken cancellationToken)
    {
        ...
        //var importInstallersCommand = await request.Mediator.Send(new ImportInstallersCommand(request.FileName, request.Data));
        ...
        //}
        //else return await Result<bool>.FailureAsync("Faild to Import Installers");
    }
}
