...
namespace CleanArchitecture.Blazor.Application.Features.TestCases.Commands;

public class DeleteAllDataCommand : IRequest<Result<bool>>
{
    public DeleteAllDataCommand() { }

}

public class DeleteAllDataCommandHandler : IRequestHandler<DeleteAllDataCommand, Result<bool>>
{
    ...
    public async Task<Result<bool>> Handle(DeleteAllDataCommand request, CancellationToken cancellationToken)
    {
