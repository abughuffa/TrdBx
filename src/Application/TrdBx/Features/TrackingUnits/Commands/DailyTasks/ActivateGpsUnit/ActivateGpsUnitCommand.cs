...
public class ActivateTrackingUnitCommand : ICacheInvalidatorRequest<Result>
{
...
public class ActivateTrackingUnitCommandHandler : SubscriptionSharedLogic, IRequestHandler<ActivateTrackingUnitCommand, Result>
{
    ...
    private readonly IStringLocalizer<ActivateTrackingUnitCommandHandler> _localizer;
    private readonly IWialonService _wialonService;
    public ActivateTrackingUnitCommandHandler(IApplicationDbContext context,
                                         IStringLocalizer<ActivateTrackingUnitCommandHandler> localizer,
                                         IWialonService wialonService)
    {
        _context = context;
    ...
    public async Task<Result> Handle(ActivateTrackingUnitCommand request, CancellationToken cancellationToken)
    {
