...
namespace CleanArchitecture.Blazor.Application.Features.DbMatchings.DTOs;

[Description("DbMatchings")]
public class DbMatchingDto
{
    ...
    //    public Mapping()
    //    {
    //        CreateMap<DbMatching, DbMatchingDto>(MemberList.None);
    //        CreateMap<DbMatchingDto, DbMatching>(MemberList.None);
    //    }
    //}
}
