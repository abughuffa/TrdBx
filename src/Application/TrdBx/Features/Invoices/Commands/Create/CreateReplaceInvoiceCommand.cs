...
//public class CreateReplaceInvoiceCommand : IRequest<Result<Invoice>>
//{
//    [Description("Invoice")]
//    public required Invoice invoice { get; set; }
//}

//public class CreateReplaceInvoiceCommandHandler : IRequestHandler<CreateReplaceInvoiceCommand, Result<Invoice>>
//{
//    private readonly IApplicationDbContext _context;
//    public CreateReplaceInvoiceCommandHandler(
//        IApplicationDbContext context)
//    {
//        _context = context;
//    }
//    public async Task<Result<Invoice>> Handle(CreateReplaceInvoiceCommand request, CancellationToken cancellationToken)
//    {
...
//                               .ApplySpecification(new UnBilledReplaceInvoiceByCustomerParentSpecification(request.invoice.CustomerId))
...
//                               .Include(s => s.Subscriptions)
//                               .Include(s => s.Customer).Where(s => s.SerDate <= request.invoice.InvDate)
//                               .ApplySpecification(new UnBilledReplaceInvoiceByCustomerChildSpecification(request.invoice.CustomerId))
//                               .ToListAsync(cancellationToken);
//        }
