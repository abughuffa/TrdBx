...
public class CreateInvoiceCommandHandler : SerialForSharedLogic, IRequestHandler<CreateInvoiceCommand, Result<int>>
{
    ...
    public async Task<Result<int>> Handle(CreateInvoiceCommand request, CancellationToken cancellationToken)
    {
        ...
        item.InvNo = GenSerialNo(db, "Invoice", request.InvDate).Result;
            ...
            case InvoiceType.Check:
                {
                    ...
                    result = await CreateCheckInvoice(db, item, cancellationToken);
            ...
            case InvoiceType.Install:
                {
                    ...
                    result = await CreatePaymentInvoice(db, item, cancellationToken);
            ...
            case InvoiceType.Replace:
                {
                    ...
                    result = await CreateReplaceInvoice(db, item, cancellationToken);
            ...
            case InvoiceType.Renew:
                {
                    ...
                    result = await CreateRenewInvoice(db, item, cancellationToken);
            ...
            case InvoiceType.Subscription:
                {
                    ...
                    result = await CreateSubscriptionInvoice(db, item, cancellationToken);
            ...
            case InvoiceType.Support:
                {
                    ...
                    result = await CreateSupportInvoice(db, item, cancellationToken);
