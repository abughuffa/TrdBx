...
//public class CreatePaymentInvoiceCommand : IRequest<Result<Invoice>>
//{
//    [Description("Invoice")]
//    public required Invoice invoice { get; set; }
//}

//public class CreatePaymentInvoiceCommandHandler : IRequestHandler<CreatePaymentInvoiceCommand, Result<Invoice>>
//{
//    private readonly IApplicationDbContext _context;
//    public CreatePaymentInvoiceCommandHandler(
//        IApplicationDbContext context)
//    {
//        _context = context;
//    }
//    public async Task<Result<Invoice>> Handle(CreatePaymentInvoiceCommand request, CancellationToken cancellationToken)
//    {
...
//                               .ApplySpecification(new UnBilledPaymentInvoiceByCustomerParentSpecification(request.invoice.CustomerId))
...
//                               .Include(s => s.Subscriptions)
//                               .Include(s => s.Customer).Where(s => s.SerDate <= request.invoice.InvDate)
//                               .ApplySpecification(new UnBilledPaymentInvoiceByCustomerChildSpecification(request.invoice.CustomerId))
//                               .ToListAsync(cancellationToken);
//        }
