...

{
    ...
    //     _context = context;
    // }
    public async ValueTask<Result<int>> Handle(DeleteInvoiceItemCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            invoice.Total = await context.InvoiceItemGroups
