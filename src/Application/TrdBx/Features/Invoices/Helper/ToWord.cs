namespace CleanArchitecture.Blazor.Application.Features.XInvoices.Helper;
...
//     #region Properties
//     static bool IsCurrencyNameFeminine = false;
//     static string Arabic1CurrencyName = "دينار ليبي";
//     static string Arabic2CurrencyName = "ديناران ليبيان";
//     static string Arabic310CurrencyName = "دنانير ليبية";
//     static string Arabic1199CurrencyName = "دينار ليبي";
//     static string Arabic1CurrencyPartName = "درهم";
//     static string Arabic2CurrencyPartName = "درهمان";
//     static string Arabic310CurrencyPartName = "دراهم";
//     static string Arabic1199CurrencyPartName = "درهماً";
//     static string ArabicPrefixText = "فقط";
//     static string ArabicSuffixText = "لاغير";
//     static byte PartPrecision = 3;
//     static bool IsCurrencyPartNameFeminine = false;
//     #endregion

//     #region Varaibles & Properties
//     static long _intergerValue;
//     static int _decimalValue;
//     #endregion
...
public class ToWord
{
    ...
    private static string GetDecimalValue(string decimalPart)
    {
        ...
        if (PartPrecision != decimalPart.Length)
        {
            ...
            // Use invariant culture for parsing to avoid culture issues
            result = Math.Round(Convert.ToDecimal(result, CultureInfo.InvariantCulture)).ToString();
        }
        else
            result = decimalPart;
    ...
    public static string ConvertToWord(decimal number)
    {
        ...
        // This ensures '.' is always used as decimal separator
        string numberString = number.ToString(CultureInfo.InvariantCulture);
        string[] splits = numberString.Split('.');

        // Parse integer part with invariant culture
        _intergerValue = Convert.ToInt32(splits[0], CultureInfo.InvariantCulture);
