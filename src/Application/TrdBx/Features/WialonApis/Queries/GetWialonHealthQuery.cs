...
public class GetWialonHealthQueryHandler : IRequestHandler<GetWialonHealthQuery, WialonHealthStatus>
{
    ...
    public async Task<WialonHealthStatus> Handle(GetWialonHealthQuery request, CancellationToken cancellationToken)
    {
...
public class GetSessionInfoQueryHandler : IRequestHandler<GetSessionInfoQuery, SessionInfo>
{
    ...
    public async Task<SessionInfo> Handle(GetSessionInfoQuery request, CancellationToken cancellationToken)
    {
