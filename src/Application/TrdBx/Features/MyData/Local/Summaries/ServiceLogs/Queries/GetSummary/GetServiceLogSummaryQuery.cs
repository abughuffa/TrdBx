using CleanArchitecture.Blazor.Application.TrdBx.Features.MyData.Local.Summaries.ServiceLogs.Caching;
using CleanArchitecture.Blazor.Application.TrdBx.Features.MyData.Local.Summaries.ServiceLogs.DTOs;
using CleanArchitecture.Blazor.Domain.Enums;
// using DocumentFormat.OpenXml.InkML;


namespace CleanArchitecture.Blazor.Application.TrdBx.Features.MyData.Local.Summaries.ServiceLogs.Queries.GetSummary;
     ...
     IRequestHandler<GetServiceLogSummaryQuery, Result<ServiceLogSummaryDto>>
{
    ...
    public async ValueTask<Result<ServiceLogSummaryDto>> Handle(GetServiceLogSummaryQuery request, CancellationToken cancellationToken)
    {
        await using var context = await _dbContextFactory.CreateAsync(cancellationToken);

        var data = await context.ServiceLogs
