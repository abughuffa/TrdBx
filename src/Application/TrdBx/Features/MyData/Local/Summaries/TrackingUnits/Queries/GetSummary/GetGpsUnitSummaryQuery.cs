using CleanArchitecture.Blazor.Application.TrdBx.Features.MyData.Local.Summaries.TrackingUnits.Caching;
using CleanArchitecture.Blazor.Application.TrdBx.Features.MyData.Local.Summaries.TrackingUnits.DTOs;
using CleanArchitecture.Blazor.Domain.Enums;
// using DocumentFormat.OpenXml.InkML;


namespace CleanArchitecture.Blazor.Application.TrdBx.Features.MyData.Local.Summaries.TrackingUnits.Queries.GetSummary;
     ...
     IRequestHandler<GetTrackingUnitSummaryQuery, Result<TrackingUnitSummaryDto>>
{
    ...
    public async ValueTask<Result<TrackingUnitSummaryDto>> Handle(GetTrackingUnitSummaryQuery request, CancellationToken cancellationToken)
    {
        await using var context = await _dbContextFactory.CreateAsync(cancellationToken);

        var data = await context.TrackingUnits
