...
namespace CleanArchitecture.Blazor.Application.TrdBx.Features.MyData.Local.TrdBxData.Commands.Import;
...
#nullable disable warnings
    public async ValueTask<Result<bool>> Handle(ImportDataCommand request, CancellationToken cancellationToken)
    {
