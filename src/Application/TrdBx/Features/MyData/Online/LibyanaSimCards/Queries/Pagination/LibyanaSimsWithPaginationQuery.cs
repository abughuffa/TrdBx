...
namespace CleanArchitecture.Blazor.Application.TrdBx.Features.MyData.Online.LibyanaSimCards.Queries.Pagination;
         ...
         IRequestHandler<LibyanaSimCardsWithPaginationQuery, PaginatedData<LibyanaSimCardDto>>
{
    ...
    public async ValueTask<PaginatedData<LibyanaSimCardDto>> Handle(LibyanaSimCardsWithPaginationQuery request, CancellationToken cancellationToken)
    {
            ...
            case LibyanaSimCardListView.All:
                {
                    ...
                    //                                cancellationToken);
                    var data = await _context.LibyanaSimCards.OrderBy($"{request.OrderBy} {request.SortDirection}")
                                   .ProjectToPaginatedDataAsync<LibyanaSimCard, LibyanaSimCardDto>(request.Specification, request.PageNumber, request.PageSize, _typeAdapterConfig, cancellationToken);
                    return data;
                }
