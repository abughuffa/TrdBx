...
public class CustomerAdvancedSpecification : Specification<Customer>
{
    public CustomerAdvancedSpecification(CustomerAdvancedFilter filter)
    {
        ...
        Query.Where(q => q.Name != null)
             ...
             .Where(x => x.CreatedAt >= todayrange.Start && x.CreatedAt < todayrange.End.AddDays(1), filter.ListView == CustomerListView.TODAY)
             .Where(x => x.CreatedAt >= last30daysrange.Start, filter.ListView == CustomerListView.LAST_30_DAYS);
